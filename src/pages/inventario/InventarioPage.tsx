...
import { Search, FileUp, ClipboardList, ArrowDownToLine, Eye, Trash2 } from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Buscar por código, produto, local..."
                value={searchTerm}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {[...Array(10)].map((_, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {['Cíclico', 'Geral', 'Pontual'][index % 3]}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {`Rua ${String.fromCharCode(65 + index % 3)}-${index + 1}`}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {['João Silva', 'Maria Santos', 'Pedro Costa', 'Ana Lima'][index % 4]}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {['Em Andamento', 'Pendente', 'Concluído', 'Cancelado'][index % 4]}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
